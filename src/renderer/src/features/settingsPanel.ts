...
const FIELDS: Field[] = [
  ...
  { key: 'snippets', label: 'Code Snippets', type: 'toggle', group: 'Editing' },
  { key: 'pathCompletion', label: 'Path Autocomplete in Strings', type: 'toggle', group: 'Editing' },
  { key: 'errorLens', label: 'Inline Error / Warning Messages', type: 'toggle', group: 'Editing' },
  { key: 'maskEnvValues', label: 'Mask Values in .env Files', type: 'toggle', group: 'Editing' },
  { key: 'useProjectLinters', label: 'Use Project ESLint / Prettier', type: 'toggle', group: 'Editing', note: "Runs the workspace's own eslint/prettier from node_modules." },
  { key: 'spellCheck', label: 'Spell Check (comments, strings, Markdown)', type: 'toggle', group: 'Editing' },
  { key: 'gitBlame', label: 'Git Blame Annotations', type: 'toggle', group: 'Editing' },
  { key: 'formatOnSave', label: 'Format On Save', type: 'toggle', group: 'Editing' },
  { key: 'organizeImportsOnSave', label: 'Organize Imports On Save', type: 'toggle', group: 'Editing' },
